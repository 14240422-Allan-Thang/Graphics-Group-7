...
function button1(){
    ...
    pgn = StorePGN(KasparovVsTopalov1999);
    StartGame(pgn);
...
function button3(){
    ...
    pgn = StorePGN(AronianVsAnand2013);
    StartGame(pgn);
}
...
function button4(){
    ...
    pgn = StorePGN(KarpovVsKasparov1985);
    StartGame(pgn);
}
...
function button5(){
    ...
    pgn = StorePGN(ByrneVsFischer1956);
    StartGame(pgn);
}
...
function button6(){
    ...
    pgn = StorePGN(IvanchukVsYusupov1991);
    StartGame(pgn);
}
...
function button8(){
    ...
    pgn = StorePGN(BaiJinshiVsDingLiren2017);
    StartGame(pgn);
}
...
function button9(){
    ...
    pgn = StorePGN(RotlewivsRubinstein1997);
    StartGame(pgn);
}
